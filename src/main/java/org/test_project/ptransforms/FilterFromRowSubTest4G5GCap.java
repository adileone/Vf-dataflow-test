...
public class FilterFromRowSubTest4G5GCap extends PTransform<PCollection<Row>, PCollection<KV<String, Row>>> {

    final static Logger logger = LoggerFactory.getLogger(FilterFromRowSubTest4G5GCap.class);
    ...
    public FilterFromRowSubTest4G5GCap(String[] keys, String typology, PCollectionView<Map<String, String>> pCollectionView, Schema schema) {
        this.keys = keys;
