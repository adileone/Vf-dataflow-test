...
public class CreateKVRowAccessoryParametersSubTest4G5GCap extends PTransform<PCollection<Row>, PCollection<KV<String, Row>>> {

    final static Logger logger = LoggerFactory.getLogger(CreateKVRowAccessoryParametersSubTest4G5GCap.class);
    ...
    public CreateKVRowAccessoryParametersSubTest4G5GCap(String[] keys, String[] accessory_parameters, String[] typologies, PCollectionView<Map<String, String>> pCollectionView, Schema schema) {
        this.keys = keys;
                ...
                .apply(ParDo.of(new DoFn<Row, Row>() {
                    ...
                    public void processElement(@Element Row row, OutputReceiver<Row> out, ProcessContext c) {
                        ...
                        for (String typo : typologies) {
                            ...
                            if (map != null &&
                                    technology.equals(Technology._4G) &&
                                    (test.equals("DL CE") ||
                                            test.equals("UL CE") ||
                                            test.equals("WB") ||
                ...
                .apply(ParDo.of(new DoFn<Row, Row>() {
                    ...
                    public void processElement(@Element Row row, OutputReceiver<Row> out, ProcessContext c) {
                        ...
                        for (String typo : typologies) {
                            ...
                            if (map != null &&
                                    technology.equals(Technology._5G_CAP) &&
                                    (test.equals("DL CE") ||
                                            test.equals("UL CE") ||
                                            test.equals("WB") ||
                                            test.equals("Streaming HD Static")) &&
